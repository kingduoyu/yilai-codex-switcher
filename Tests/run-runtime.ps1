...
try {
    ...
    $compileArgs = @('-std=c++17','-O2','-DUNICODE','-D_UNICODE','-DWINVER=0x0A00','-D_WIN32_WINNT=0x0A00','-municode','-static','-Wno-deprecated-literal-operator',
        '-I','Sources/ConfigRewrite/include','-I','Sources/HistorySync/include','-I','Sources/Diagnostics/include','-I','Sources/OperationGuard/include','Tests/driver.cpp','Windows/Platform.cpp','Sources/ConfigRewrite/config_rewrite.cpp','Sources/HistorySync/history_sync.cpp','Sources/Diagnostics/diagnostics.cpp','Sources/OperationGuard/operation_guard.cpp','dist/windows/sqlite3.o',
