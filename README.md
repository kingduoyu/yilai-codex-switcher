...
下载使用 [GitHub Releases](https://github.com/kingduoyu/yilai-codex-switcher/releases/latest) 页面中的当前版本附件。安装包名称包含版本号；不使用不存在的 `releases/latest/download/YilaiCodexSwitcher.exe` 旧式直链。
