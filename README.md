...
- Windows 10/11 x64：从 [Releases](https://github.com/kingduoyu/yilai-codex-switcher/releases/latest) 下载 v3.2.2 `YilaiCodexSwitcher.exe`，无需安装运行库。
- macOS 13+：下载 v3.2.2 `YilaiCodexSwitcher-macOS-universal.dmg`，同时支持 Intel 与 Apple Silicon。
